        ...
        <div class="flex flex-col md:flex-row gap-8">
            <div class="w-full md:w-1/4 bg-white rounded-lg shadow-md p-6">
                ...
                <ul class="space-y-4">
                    <li>
                        <a
                            href="{{ route('themhoso') }} "class="flex items-center space-x-3 text-blue-600 font-semibold p-3 bg-blue-50 rounded-lg transition duration-300 hover:bg-blue-100">
                    ...
                    <li>
                        <a href="{{ route('trochuyenuser') }}"
                            class="flex items-center space-x-3 text-gray-700 p-3 rounded-lg transition duration-300 hover:bg-gray-100 relative">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <p><span class="font-semibold">Giới tính:</span>
                            ...
                            <div class="flex justify-end space-x-4 mt-6 border-t pt-4">
                                <button data-id="{{ $record->id_pr }}"
                                    class="btn-delete text-red-500 hover:text-red-700 transition duration-300 flex items-center space-x-1">
                                    <i class="fas fa-trash-alt"></i>
                                    <span>Xóa hồ sơ</span>
                                </button>
                                <button data-id="{{ $record->id_pr }}" data-name="{{ $record->prname }}"
                                    data-birthday="{{ $record->birthday }}" data-phone="{{ $record->phonenumber }}"
                                    data-gender="{{ $record->gender }}" data-address="{{ $record->address }}"
                                    class="btn-edit text-blue-500 hover:text-blue-700 transition duration-300 flex items-center space-x-1">
...
<!-- Modal sửa hồ sơ -->
<div class="modal fade" id="edit-profile-modal" tabindex="-1" role="dialog" aria-labelledby="editProfileModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
