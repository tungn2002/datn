        ...
        @isset($medicalResults)
            ...
            <tr>
                ...
                <td class="text-center">
                    <a style="color: white; border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;" class="btn btn-primary" href="{{ route('xacnhanduyet', ['id' => $item->id_result]) }}">Duyệt</a>
