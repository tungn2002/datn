        ...
        <div class="sidebar pe-4 pb-3"
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('doctor') }}" class="nav-item nav-link active"><i class="far fa-id-card"></i>Thông
                        tin cá nhân</a>
            ...
            <div class="container-fluid pt-4 px-4 ">
                ...
                <div class="col-sm-12 col-xl-6"
                    ...
                    <div class="image-container">
                        <img style="height: 150px;width: 150px" src="{{ asset('image/' . Auth::user()->avatar) }}"
                            alt="Left Image" class="left-image">
                        <img style="height: 100px;width: 100px" src="{{ asset('image/' . Auth::user()->signature) }}"
                            alt="Right Image" class="right-image">
                    </div>
                    <hr style="  border-top: 1px dashed black">
                    @isset($clinic)
                        <p><i class="fas fa-clinic-medical"></i> Phòng làm việc: <b
                                style="color: #003553">{{ $clinic->clinicname }}</b></p>
                        <p><i class="fas fa-briefcase"></i> Dịch vụ khám: <b
                                style="color: #003553">{{ $clinic->servicename }}</b></p>
