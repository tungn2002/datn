...
@endif
  ...
  <a href=" {{ route('profile32') }}" class="btn btn-primary" style="border-radius: 2rem ; border-width: 0px;background-image: #4cf5bc;"><b>Chưa thanh toán</b></a>
  <a href=" {{ route('profile33') }}" class="btn btn-primary"  style="color: #000000;border-radius: 2rem ; border:3px solid #4cf5bc;background-color: #EEEDEB"><b>Đã thanh toán và đã khám</b></a>
...
<p class="card-text" style="display: flex; justify-content: space-between;">
    <span style="flex: 1;"><i class="fas fa-stopwatch"></i> Giờ kết thúc:</span>
    <span style="text-align: right; white-space: nowrap;">{{ substr($record->finishtime, 0, 5) }}</span>
</p>
