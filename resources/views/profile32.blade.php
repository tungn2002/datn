    ...
    <div class="flex flex-col md:flex-row gap-8">
        <div class="w-full md:w-1/4 bg-white rounded-lg shadow-md p-6">
            ...
            <li>
                ...
                <li>
                    <a href="{{ route('profile3') }}" class=" {{ request()->routeIs('profile32') ? 'border-2 border-blue-500' : '' }} flex items-center space-x-3 text-gray-700 p-3 rounded-lg transition duration-300 hover:bg-gray-100">
