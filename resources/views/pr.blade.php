        ...
        <div class="sidebar pe-4 pb-3"
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('pr-index') }}" class="nav-item nav-link active"><i
                            class="fas fa-user-injured"></i>Hồ sơ</a>
                    ...
                    @isset($patientRecords)
                        @foreach ($patientRecords as $record)
                            <tr>
                                ...
                                <td>{{ $record->gender == 'male' ? 'Nam' : ($record->gender == 'female' ? 'Nữ' : 'Khác') }}
                                </td>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning btn-edit" data-bs-toggle="modal"
                                        ...
                                        data-id="{{ $record->id_pr }}">Sửa</button>
                                    <button class="btn btn-danger btn-delete" data-bs-toggle="modal"
                                        style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;"
                                        data-bs-target="#deleteModal" data-id="{{ $record->id_pr }}">Xóa</button>
                                </td>
                            </tr>
                        @endforeach
                    @endisset
