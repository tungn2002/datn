        ...
        <div class="sidebar pe-4 pb-3" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border: 1px solid rgba(0, 0, 0, 0.1);">
            <nav class="navbar bg-light navbar-light" >
                ...
                <div class="navbar-nav w-100" >
                    ...
                    <a href="{{ route('pr-index') }}" class="nav-item nav-link active"><i class="fas fa-user-injured"></i>Hồ sơ</a>
        ...
        <div class="content">
            ...
            <div class="col-sm-12 col-xl-6"  style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; width: 50em">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="prname" id="prname" value="{{ old('prname') }}" required> 
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="tel" class="form-control" name="phonenumber" id="phonenumber" value="{{ old('phonenumber') }}" required>
                    </div>
                </div>
                <div class="row mb-3">
...
@endif
    ...
    <div class="col-md-4">
        <a class="btn btn-primary" href="{{ route('pr-index') }}">Tất cả</a>
    </div>   
</form>
</div>
            ...
            @foreach ($patientRecords as $record)
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-warning btn-edit" data-bs-toggle="modal" data-bs-target="#editModal"  style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;" data-id="{{ $record->id_pr }}">Sửa</button>
                        <button class="btn btn-danger btn-delete" data-bs-toggle="modal"  style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;" data-bs-target="#deleteModal" data-id="{{ $record->id_pr }}">Xóa</button>
                    </td>
                </tr>
            @endforeach
        @endisset
