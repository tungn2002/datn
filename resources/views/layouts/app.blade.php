...
<head>
    ...
    <style>
        ...
        .hero-background::before {
            ...
            background-color: rgba(0, 0, 0, 0.05); /* màu trắng với độ mờ */
            z-index: 1;
        }
        ...
        @media (max-width: 768px) {
            ...
            .hero-background::before {
                height: 80px; /* Smaller wave for mobile */
            }
        }
    </style>
</head>
...
<div class="bg-blue-500 py-2 px-5 shadow-sm text-white">
  ...
  <nav class="bg-white py-2 px-2 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 text-medium font-medium">
                <a href="{{ route('servicef') }}" class="hover:text-blue-600 transition duration-300">Đặt khám</a>
                    ...
                    @else
                        <a href="{{ route('trochuyenuser') }}" class="hover:text-blue-600 transition duration-300">Hỏi đáp bác sĩ</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white mt-2 py-2 rounded-lg shadow-lg">
            ...
            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-blue-50 hover:text-blue-600">Hỏi đáp bác sĩ</a>
            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-blue-50 hover:text-blue-600">Hồ sơ sức khỏe</a>
        </div>
    </nav>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-400 transition duration-300">Đăng ký bán hàng trên IVIE - Shopping Mall</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400 text-sm">
                    <li><a href="#" class="hover:text-blue-400 transition duration-300">Hỏi đáp bác sĩ</a></li>
                    <li><a href="#" class="hover:text-blue-400 transition duration-300">Trở thành đối tác của IVIE - Bác sĩ ơi</a></li>
                    <li><a href="#" class="hover:text-blue-400 transition duration-300">Cơ sở y tế</a></li>
                    <li><a href="#" class="hover:text-blue-400 transition duration-300">Trung tâm trợ giúp</a></li>
                </ul>
            </div>
            ...
            <div class="flex flex-col items-center md:items-start">
                ...
                <div class="flex flex-col space-y-3 mb-6">
                    <a href="#" class="bg-gray-700 text-white py-2 px-4 rounded-full flex items-center space-x-2 shadow-md transition duration-300 hover:bg-gray-600">
                ...
                <div class="flex space-x-4 mb-6">
                    <a href="#" class="text-gray-400 hover:text-blue-400 transition duration-300"><i class="fab fa-facebook-f text-xl"></i></a>
                    ...
                    <a href="#" class="text-gray-400 hover:text-blue-400 transition duration-300"><i class="fab fa-youtube text-xl"></i></a>
                </div>
                <div class="flex space-x-4">
                    <img src="https://placehold.co/100x40/0A2540/FFFFFF?text=BoCongThuong" alt="Bộ Công Thương" class="h-10">
                    <img src="https://placehold.co/100x40/0A2540/FFFFFF?text=DMCA" alt="DMCA Protected" class="h-10">
                </div>
            </div>
        </div>
        <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-xs">
            <p>&copy; 2022 ISOFHCARE. All rights reserved. Giấy phép đăng ký kinh doanh số 0108600757 do Sở Kế hoạch & Đầu tư TP Hà Nội cấp lần đầu ngày 23/01/2019. Người chịu trách nhiệm nội dung: Bà Nguyễn Bích Phượng. Chức vụ: Giám đốc vận hành</p>
        </div>
    </div>
</footer>
