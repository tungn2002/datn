                ...
                <ul class="space-y-4">
                    ...
                    <li>
                        <a href="{{ route('profile3') }}"
                            class=" {{ request()->routeIs('profile3') ? 'border-2 border-blue-500' : '' }} flex items-center space-x-3 text-gray-700 p-3 rounded-lg transition duration-300 hover:bg-gray-100">
