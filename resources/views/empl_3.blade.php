    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4 ">
                ...
                <a href="{{ route('empl_choduyet') }}" class="btn btn-primary" style="border-radius: 2rem ;">Chờ
                    duyệt</a>
                <a href="{{ route('empl_chothanhtoan') }}" type="button" class="btn btn-primary"
                    style="border-radius: 2rem ; border-width: 0px;background-image: linear-gradient(to left, #4cf5bc 0%, #07d590 100%);">Thanh
                    toán</a>
                ...
                <table class="table table-striped table-bordered table-hover mt-4"
                    ...
                    <div style="display: flex; align-items: center;" class="mt-5">
                        <form action="{{ route('findchothanhtoan') }}">
                            <input type="tel" style="width: 250px" class="form-control" name="dl"
                                placeholder="Nhập số điện thoại...">
                            <button class="btn btn-primary" type="submit" style="margin-left: 5px;"> <i
                                    class="fas fa-search"></i> Tìm kiếm</button>
                        </form>
                        <a class="btn btn-primary" style="margin-left: 5px;"
                            href="{{ route('empl_chothanhtoan') }}">Tất cả</a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a style="color: white; border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;"
                                        ...
                                        href="{{ route('xacnhanthanhtoan', ['id' => $item->id_result]) }}">Xác nhận</a>
