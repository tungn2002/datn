    ...
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Trò chuyện với bác sĩ</li>
          </ol>
        </nav>
	        ...
	        background: linear-gradient(to right, #91EAE4, #86A8E7, #7F7FD5);">
									<div class="card-header msg_head">
											<div class="d-flex bd-highlight">
												<div class="img_cont">
													<img src="{{ asset('image/' . $u->avatar) }}" class="rounded-circle user_img">
												</div>
												<div class="user_info">
													<span>    @isset($u)
										...
										<span id="action_menu_btn"><a href="{{ route('pdff2', ['id' => $idcon]) }}" class="btn btn-primary">Đơn thuốc</a></span>
									</div>
