        ...
        <div class="sidebar pe-4 pb-3" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border: 1px solid rgba(0, 0, 0, 0.1);">
            <nav class="navbar bg-light navbar-light" >
                ...
                <div class="navbar-nav w-100" >
                    ...
                    <a href="{{ route('medicine-index') }}" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Thuốc</a>
                    ...
                    <a href="{{ route('pr-index') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Hồ sơ</a>
            ...
            <div class="modal-body">
                ...
                @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control"  id="address" name="detail" rows="3"></textarea>
                    </div> 
                    <div class="mb-3">
