        ...
        <div class="sidebar pe-4 pb-3" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border: 1px solid rgba(0, 0, 0, 0.1);">
            <nav class="navbar bg-light navbar-light" >
                ...
                <div class="navbar-nav w-100" >
                    <a href="{{ route('admin1') }}" class="nav-item nav-link "><i class="fa fa-tachometer-alt "></i>Bảng điều khiển</a>
                    ...
                    <a href="{{ route('medicine-index') }}" class="nav-item nav-link active"><i class="fas fa-capsules"></i>Thuốc</a>
            ...
            <div class="col-sm-12 col-xl-6"  style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; width: 50em">
                        <div class="bg-light rounded h-100 p-4"style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-right: 3px solid rgba(0, 0, 0, 0.1); border-left: 3px solid lightblue; border-top: 3px solid lightblue; border-bottom: 1px solid lightblue; padding: 20px; border-radius: 10px;">
                            ...
                            @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Tên thuốc:</label>
                                    <div class="col-sm-10"> 
                                        <input type="text" class="form-control" name="medicinename" id="inputEmail3" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Chi tiết:</label>
                                    <div class="col-sm-10">
                                    <textarea class="form-control"  id="detail" name="detail" rows="3" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Thành phần:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="ingredient" id="inputEmail3" required>
                                    </div>
                                </div>
...
@endif
            ...
            <div class="row mt-5" style="width: 40%">
                    <form action="{{ route('findmedi') }}" class="w-100 d-flex" >
    <div class="col-md-8">
        <input type="text" class="form-control" name="dl" placeholder="Nhập tên thuốc...">
    </div>
    <div class="col-md-4">
        <button type="submit" class="btn btn-primary"><i class="fas fa-search"></i> Tìm kiếm</button>
    </div>   
    <div class="col-md-4">
        <a class="btn btn-primary" href="{{ route('medicine-index') }}">Tất cả</a>
    </div>   
</form>
</div>
    ...
    @isset($medicine)
                            ...
                            <td>
                                ...
                                <button class="btn btn-warning btn-edit" data-bs-toggle="modal" data-bs-target="#editModal" style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;" data-id="{{ $item->id_medicine }}">Sửa</button> 
                                    <button class="btn btn-danger btn-delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$item->id_medicine}}" style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;">Xóa</button>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog">
        <form method="POST" action="{{ route('xoamedicine') }}" id="deleteForm"> 
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id_medicine" id="hospitalIdInput">
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @csrf
                    ...
                    <div class="mb-3">
                        <label for="hospitalname" class="form-label">Tên thuốc:</label>
                        <input type="text" class="form-control" id="hospitalname" name="medicinename" required>
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Chi tiết:</label>
                        <textarea class="form-control"  id="address" name="detail" rows="3" required></textarea>
                    </div> 
                    <div class="mb-3">
                        <label for="hospitalname" class="form-label">Thành phần:</label>
                        <input type="text" class="form-control" id="hh" name="ingredient" required>
                    </div>
...
$('.btn-edit').click(function() {
    ...
    $('#editForm').attr('action', '{{ url("capnhatmedicine") }}/id=' + hospitalId); 
