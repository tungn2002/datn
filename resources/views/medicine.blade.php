        ...
        <div class="sidebar pe-4 pb-3"
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('medicine-index') }}" class="nav-item nav-link active"><i
                    ...
                    <div
                        ...
                        <form action="{{ url('addmedicine') }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="medicinename" id="inputEmail3"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="ingredient" id="inputEmail3"
                                        required>
                                </div>
                            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-edit" data-bs-toggle="modal"
                                    ...
                                    data-id="{{ $item->id_medicine }}">Sửa</button>
                                <button class="btn btn-danger btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-id="{{ $item->id_medicine }}"
                    ...
                    <div class="modal-body">
                        <form id="editForm" action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="hospitalname" name="medicinename"
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="hh" name="ingredient"
                                    required>
                            </div>
