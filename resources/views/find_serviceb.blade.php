    ...
    <div class="page-section">
        <div class="container">
            ...
            <div class="sidebar-block">
                ...
                <div class="row"></div>
                <a href="{{ route('servicef') }}" class="btn btn-primary"
                    style="border: 2px solid #00D9A5;background-color: #fff; color: #000000	">Dịch vụ</a>
        ...
        ">
            ...
            ">
                                        ...
                                        <a href="{{ route('servicebf', ['id' => $item->id_user]) }}"
                                            class="btn btn-primary mt-auto" style="margin-top: auto;">Đặt khám</a>
                                    </div>
                                </div>
                            @endforeach
                        @endisset
