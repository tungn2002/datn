        ...
        <div class="sidebar pe-4 pb-3"
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('clinic-index') }}" class="nav-item nav-link active"><i
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-edit"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#editModal" style="color:white;"
                                    data-id="{{ $item->id_clinic }}">Sửa</button>
                                <button class="btn btn-danger btn-delete"
                                    style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;"
                                    data-bs-toggle="modal" data-bs-target="#deleteModal"
                                    data-id="{{ $item->id_clinic }}">Xóa</button>
                                <a class="btn btn-primary"
                                    href="{{ route('app-index2', ['id' => $item->id_clinic]) }}">Lịch khám</a>
                        ...
                        <form id="editForm" action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="id_user" id="phongban3">
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id_user }}">{{ $user->name }}-{{ $user->spname }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
