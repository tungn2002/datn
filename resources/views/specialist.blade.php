        ...
        <div class="sidebar pe-4 pb-3"
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('specialist-index') }}" class="nav-item nav-link active"><i
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-edit" data-bs-toggle="modal"
                                    ...
                                    data-id="{{ $item->id_specialist }}">Sửa</button>
                                <button class="btn btn-danger btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-id="{{ $item->id_specialist }}"
