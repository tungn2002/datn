                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{ route('qlnhanvien') }}" class="dropdown-item"><i class="fas fa-users-cog"></i>
                                Nhân viên</a>
                            <a href="{{ route('qlkhachhang') }}" class="dropdown-item"><i class="fas fa-user"></i> Khách
                                hàng</a>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-xl-6" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; width: 50em">
                    <div class="bg-light rounded h-100 p-4"
                        ...
                        <form action="{{ url('addapp') }}" method="post">
                            ...
                            <div class="mb-3">
                                <label for="time" class="form-label"><i class="far fa-clock"></i> Thời gian hoàn
                                    thành (dự kiến): {{ substr($service->time, 0, 5) }}</label>
                            </div>
                            <div class="mb-3">
                                <label for="time" class="form-label"><i class="far fa-calendar-check"></i> Thời
                                    gian làm việc của bác sĩ:</label>
                                <div
                                    style="border-top: 1px solid lightblue;border-left: 1px solid lightblue;   border-radius: 5px; padding: 3px;background-color:#fff7d1;box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.2);">
                                    <p>{!! nl2br($user->working_hours) !!}</p>
                                </div>
                            </div>
                    ...
                    <form action="{{ route('findapp', ['id' => $clinics->id_clinic]) }}" class="w-100 d-flex">
                        ...
                        <div class="col-md-4">
                            <a class="btn btn-primary"
                                href="{{ route('app-index2', ['id' => $clinics->id_clinic]) }}">Tất cả</a>
                        </div>
                    </form>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning btn-edit"
                                        ...
                                        data-id="{{ $appointment->id_appointment }}">Sửa</button>
                                    <button class="btn btn-danger btn-delete"
                                        style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;"
                                        data-bs-toggle="modal" data-bs-target="#deleteModal"
                                        data-id="{{ $appointment->id_appointment }}">Xóa</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                @isset($appointments)
                    <div class="container-footer-kt">
                        <nav aria-label="Page navigation example"
                            class="ml-5 footer-kt"style="display: flex; justify-content: center;">
