...
<body>
    ...
    <div class="page-section">
        <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <div style="height: 100%; display: flex; align-items: center;">
                            <img src="{{ asset('image/' . $service->image) }}" class="card-img" alt="..."
                                style="height: 150px;width:200px ;object-fit: cover; width: auto;">
                        </div>
                    </div>
                    <div class="col-md-8" style="padding-left:2em">
                        <div class="card-body">
                            <h5 class="card-title mb-1">Dịch vụ: {{ $service->servicename }}</h5>
                            <p class="card-text mb-1">Giá:<span style="color: #049371;">
                                    {{ number_format($service->price, 0, '', '.') }} đồng</span> </p>
            ...
            <div class="card mb-3"
                style="height: 150px; overflow-x: auto;border: 2px solid #049371; background-color: #f9f9f9; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 10px;">
                <div style="padding:10px;">

                    @if (count($app))
                        <h4><b style="color: #049371;"> Chọn giờ:</b></h4>
                        <div class="btn-group d-flex flex-nowrap"
                            style="width: fit-content; max-width: 100%; margin-top: 10px; white-space: nowrap; overflow-x: auto;">
                            @foreach ($app as $item)
                                <a href="{{ route('serviceffff', ['id' => $item->id_appointment]) }}"
                                    class="btn btn-primary mb-2 mr-2">{{ substr($item->time, 0, 5) }}</a>
                            @endforeach
                        </div>
                    @else
            ...
            <div class="card mb-3"
                style="border: 2px solid #049371; background-color: #f9f9f9; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 10px;">
