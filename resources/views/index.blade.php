        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 relative z-10">
            <div class="text-center md:text-left md:w-1/2 mb-8 md:mb-0">
                ...
                <div class="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                    <a href="{{ route('servicef') }}"
                        class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-full shadow-lg transition duration-300 transform hover:scale-105">
                        <i class="fas fa-calendar-check mr-2"></i> Đặt khám
                    </a>
                    <a href="{{ route('trochuyenuser') }}"
                        class="bg-white text-blue-600 border border-blue-600 font-semibold py-3 px-6 rounded-full shadow-lg transition duration-300 transform hover:scale-105 hover:bg-blue-50">
    ...
    <section class="py-10 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div
                    class="bg-white rounded-2xl shadow-xl p-6 text-center transform transition duration-300 hover:scale-105 hover:shadow-2xl">
                    <div
                        class="w-16 h-16 mx-auto mb-4 bg-green-100 rounded-full flex items-center justify-center text-green-600 text-3xl">
                ...
                <div
                    class="bg-white rounded-2xl shadow-xl p-6 text-center transform transition duration-300 hover:scale-105 hover:shadow-2xl">
                    <div
                        class="w-16 h-16 mx-auto mb-4 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-3xl">
                ...
                <div
                    class="bg-white rounded-2xl shadow-xl p-6 text-center transform transition duration-300 hover:scale-105 hover:shadow-2xl">
                    <div
                        class="w-16 h-16 mx-auto mb-4 bg-purple-100 rounded-full flex items-center justify-center text-purple-600 text-3xl">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
                    ...
                    @foreach ($service as $item)
                        <div class="swiper-slide p-4">
                            <div
                                ...
                                <img src="{{ asset('image/' . $item->image) }}" alt="{{ $item->servicename }}"
                                ...
                                <a href="{{ route('serviceff', ['id' => $item->id_clinic]) }}"
            ...
            <div class="text-center mt-8">
                <a href="#"
                    class="text-blue-600 hover:text-blue-800 font-semibold text-lg transition duration-300">Xem tất cả
                    &gt;&gt;</a>
            </div>
        </div>
    </section>
                            ...
                            @foreach ($docter as $item)
                                <div class="swiper-slide">
                                    <div class="ml-3 mb-3 bg-white rounded-2xl p-6 text-center flex flex-col items-center transform transition duration-300 hover:scale-105"
                                        ...
                                        <p class="text-blue-600 font-medium mb-2"><i
                                                class="fas fa-stethoscope mr-1"></i>{{ $item->spname }}</p>
                                        <p class="text-gray-500 text-sm mb-4"><i class="fas fa-user-tie mr-1"></i> Bác sĩ Chuyên
                                            Khoa</p>
