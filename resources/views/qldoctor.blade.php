...
<table  class="table table-striped table-bordered table-hover mt-4" style="border:1px solid #d4d4d4 ;border-radius: 12px; overflow: hidden;border-collapse: separate; border-spacing: 0;">
    ...
    @isset($user)
                            ...
                            <tr>
                                ...
                                <td><img style="width: 40px; height: 40px"class="" src="{{ asset('image/' . $item->avatar) }}" ></td>
                                ...
                                <button class="btn btn-warning btn-edit" data-bs-toggle="modal"  style=" border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;" data-bs-target="#editModal" data-id="{{ $item->id_user }}">Sửa</button> 
