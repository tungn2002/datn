...
<head>
    ...
    <style>
        .alert-popup {
            ...
            /* Chia thành 2 cột: icon tự động, chữ chiếm phần còn lại */
            align-items: center;
...
<body>
    ...
    <div class="page-section">
        <div class="container">
                    ...
                    @foreach ($nv as $item)
                        <div class="col" style="padding-left:100px">
                            <div class="card-custom m-2 d-flex flex-column" style="height:220px">
                                ...
                                <a href="{{ route('chatuser', ['id' => $item->id_user]) }}"
                                    class="btn btn-primary mt-auto">Trò chuyện</a>
                            </div>
                        </div>
                    @endforeach
                @endisset
                    ...
                    @foreach ($chuachat as $item)
                        <div class="col" style="padding-left:100px">
                            <div class="card-custom m-2 d-flex flex-column">
                                ...
                                <p>{{ $item->spname }}</p>
                                <p>Giá: <span
                                        style="color: #244983"><b>{{ number_format($item->price, 0, '', '.') }}đ</b></span>
                                </p>
                    ...
                    @foreach ($dachat as $item)
                        <div class="col" style="padding-left:100px">
                            <div class="card-custom m-2 d-flex flex-column">
                                ...
                                <h5 class="mt-3" style="font-size: 16px;font-weight: bold;">{{ $item->name }}</h5>
                                <p>CK: {{ $item->spname }}</p>
                                <a href="{{ route('chatuser2', ['id' => $item->id_user]) }}"
                                    class="btn btn-primary mt-auto">Trò chuyện</a>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="card mb-3"
                style="margin-top:50px;border: 2px solid #049371; background-color: #f9f9f9; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 10px;">
                <h4 style="padding: 10px 10px 0; color: #049371;"><b>Chi tiết:</b></h4>
                <p style="margin: 1em 3em; font-size: 1em; line-height: 1.5; color: #333;">Nhận được sự tư vấn y tế và
                    đơn thuốc từ các bác sĩ (Các bệnh,triệu chứng nhẹ thường gặp như: cảm cúm, cảm lạnh,...)</p>
            </div>
        </div>
