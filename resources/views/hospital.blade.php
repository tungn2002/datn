        ...
        <div class="sidebar pe-4 pb-3"
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('hospital-index') }}" class="nav-item nav-link active"><i
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-edit"
                                    ...
                                    data-id="{{ $item->id_hospital }}">Sửa</button>
                                <button class="btn btn-danger btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal"
                                    style="color: white; border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); border: none; transition: background-color 0.3s, transform 0.3s;"
                                    data-id="{{ $item->id_hospital }}">Xóa</button>
                            </td>
                        </tr>
                    @endforeach
                @endisset
